...
def main():
    ...
    command = [sys.executable, '-m', 'pytest',
               str(ROOT / 'test_p3_night.py'), str(ROOT / 'test_p3_transit.py'),
               str(ROOT / 'test_p3_joint.py'),
               str(ROOT / 'test_p3_evaluation.py'),
               str(ROOT / 'test_p3_task.py'),
               str(ROOT / 'test_practice_safety.py'),
    ...
    files = [ROOT / 'candidates.py', ROOT / 'run_practice.py', ROOT / 'test_p3_night.py',
             ROOT / 'test_p3_transit.py', ROOT.parent / '第三问/v10/strategy_night.py',
             ROOT / 'test_p3_joint.py', ROOT.parent / '第三问/v10/strategy_joint.py',
             ROOT / 'test_p3_evaluation.py', ROOT / 'p3_evaluation.py',
             ROOT / 'p3_metrics.py', ROOT / 'p3_reference.py', ROOT / 'benchmark_speed.py',
             ROOT / 'test_p3_task.py', ROOT.parent / '第三问/v10/strategy_task.py',
             ROOT.parent / '第三问/v10/strategy_transit.py']
