...
def make_close25():
    return AdaptiveV9(opportunistic_radius=300.0, first_hop=None, lateral=25.0,
                      probe_radius=80.0)


def make_close40():
    return AdaptiveV9(opportunistic_radius=300.0, first_hop=None, lateral=40.0,
                      probe_radius=80.0)


def make_advance500():
    return AdaptiveV9(opportunistic_radius=300.0, first_hop=500.0, lateral=60.0,
                      probe_radius=80.0)
